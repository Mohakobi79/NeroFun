...
conn.sendMessage(m.chat, {
      ...
      conn.sendFile(m.chat, media.sound, '', null, m, true)
      })
...
conn.reply(m.chat, list2, m).then(() => {
      conn.sendFile(m.chat, media.sound, '', null, m, true)
      })
